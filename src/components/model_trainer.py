...
# evaluate_model is function in utils, take all models-> fit X_train and y_train, predction on x_train and x_test-> calculate r2
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            model_report:dict=evaluate_models(X_train=X_train, y_train= y_train, X_test= X_test, y_test= y_test, models=models,param=params) # add additional arg for hyper parameter tuning

            #evalaute_returns the list of models. sort the scores of all model, get the best using max(). value is the model score
